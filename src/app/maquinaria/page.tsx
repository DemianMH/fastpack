...
export default function MaquinariaPage() {
  // Filtramos productos que sean maquinaria, pesaje, seguridad, etc.
    ...
    <main className="bg-gray-50 min-h-screen pb-20">
      ...
      <section className="bg-[#1e5f74] text-white py-16 relative overflow-hidden">
         ...
         <div className="relative max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-2xl mx-auto text-gray-200">Automatización y eficiencia para tu final de línea. Tecnología que optimiza tu producción.</p>
         </div>
      </section>
