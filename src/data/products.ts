...
export const products: Product[] = [
  ...
  // --- MATERIALES (Keywords: Insumos, Protección) ---
  { 
    id: 16, 
  ...
  // --- OTROS & LOGÍSTICA ---
  { id: 6, name: "Paletizadora Automática ACMI", category: "Maquinaria", description: "Robot paletizador de alta velocidad para botellas, latas y cajas. Estabilidad de carga garantizada.", image: "https://placehold.co/600x400/1e5f74/ffffff?text=Paletizadora+ACMI" },
  { id: 25, name: "Sistema de Carga Abatible Vehicular", category: "Vehicular", description: "Adaptación para Mercedes-Benz y vans de carga: convierte asientos en área plana para maximizar espacio.", image: "https://placehold.co/600x400/1e5f74/ffffff?text=Sistema+Abatible" },
  { id: 30, name: "Logística y Paquetería Tijuana-GDL", category: "Servicios", description: "Servicio integral de importación, recolección y envío de mercancía desde Tijuana a todo el interior de la República.", image: "https://placehold.co/600x400/1e5f74/ffffff?text=Logistica+Aduanal" },
];